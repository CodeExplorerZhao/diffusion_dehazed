...
def parse_args_and_config():
    ...
    parser.add_argument('--resume', default='/home/yueyinlei/paper/new_path/DFG-DDM/ckpts/all/Sate_ddpm_data_fft_1640000.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='Haze1k',
                        help="restoration test set options: ['rshaze', 'satehaze1k', 'rsid']")
    parser.add_argument("--image_folder", default='test_results/images_all_1640000/', type=str,
